...
StealResource::StealResource(int stolenBoatholdId, int winnerIndex, int loserIndex, int winnerBoatholdId) : winnerIndex(winnerIndex), loserIndex(loserIndex), winnerBoatholdId(winnerBoatholdId), stolenBoatholdId(stolenBoatholdId){}
